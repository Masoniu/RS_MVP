            ...
            <div class="content-wrapper mx-auto" :style="activeTab === 'map' ? 'max-width: 1100px;' : 'max-width: 600px;'">
                ...
                <template v-else>
                    ...
                    <div v-if="activeTab === 'map'" class="d-flex flex-column flex-lg-row gap-4 align-items-start w-100">
                        ...
                        <div class="map-placeholder flex-column glass-box p-0 overflow-hidden w-100 position-relative" :class="selectedLocations.length >= 3 ? 'd-flex mb-4' : 'd-none d-lg-flex'" style="flex: 1; min-height: 450px;">
