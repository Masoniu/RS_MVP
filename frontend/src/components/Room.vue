...
<template>
    <div class="room-page d-flex flex-column min-vh-100">
        ...
        <header class="room-header d-flex align-items-center justify-content-between px-4 py-3 z-3 mb-4">
            ...
            <nav class="desktop-nav d-none d-md-flex align-items-center justify-content-center">
                <div class="desktop-nav-item">Мапа</div>
                <div class="desktop-nav-item active">Учасники</div>
                <div class="desktop-nav-item">Витрати</div>
            </nav>
        ...
        <main class="flex-grow-1 px-4 py-4 main-content z-2">
